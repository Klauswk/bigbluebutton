...
class ChatOnlyNavbar extends Component {
  constructor(props) {
    super(props);
...
ChatOnlyNavbar.propTypes = propTypes;
ChatOnlyNavbar.defaultProps = defaultProps;
export default withModalMounter(injectIntl(ChatOnlyNavbar));
